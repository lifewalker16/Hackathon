...
// import SolarFlareDashboard from "./components/SolarFlareDashboard";
...
import SolarFlare3D from "./components/SolarFlarePosition";
import ApplyEarth from "./components/ApplyEarth";
...
export default function App() {
  ...
  return (
    <>
      {/* {!showSolarFlare && (
        <PartOne onExplore={() => setShowSolarFlare(true)} />
      )}
      {showSolarFlare && (
       <>
        <SolarFlare3D />
